...
/**
 * POST /api/spot/deposit/complete
 * 
 * Triggered when Arb USDC arrives in the trading wallet.
 * Performs two operations:
 *   1. Bridge trading wallet USDC → HL Bridge2 (lands in Perps)
 *   2. Wait for HL credit, then usdClassTransfer Perps → Spot
 */
