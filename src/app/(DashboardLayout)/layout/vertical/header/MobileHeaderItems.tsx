...
const MobileHeaderItems = () => {
  ...
  return (
    <Navbar
      fluid
      className="rounded-none bg-white dark:bg-dark flex-1 px-0 "
    >
      {/* Toggle Icon   */}
        ...
        <div className="flex justify-center items-center">
          ...
          {activeMode === "light" ? (
            <div
              ...
              onClick={toggleMode}
            >
              <span className="flex items-center justify-center relative after:absolute after:w-10 after:h-10 after:rounded-full after:-top-1/2   group-hover:after:bg-primary/20">
                <Icon
                  icon="tabler:moon"
                  width="20"
