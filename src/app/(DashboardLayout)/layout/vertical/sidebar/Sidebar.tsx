...
const SidebarLayout = () => {
  ...
  return (
    <aside
      className="fixed left-0 top-0 h-screen w-[260px] bg-white dark:bg-black border-r border-border dark:border-darkborder z-10 xl:block hidden"
    ...
    >
      ...
      <SimpleBar style={{ height: 'calc(100vh - 64px)', maxHeight: 'calc(100vh - 64px)' }} autoHide={false}>
